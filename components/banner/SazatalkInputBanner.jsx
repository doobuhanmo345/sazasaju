...
const SazatalkInputBanner = () => {
    ...
    return (
        <>
            ...
            {/* 2. 카카오톡 스타일 전체 화면 모달 */}
            {isOpen && (
                <div id="sazatalk-modal" className="fixed inset-0 z-[100] flex items-end justify-center bg-[#abc1d1] sm:bg-black/50 backdrop-blur-sm animate-in fade-in duration-300">
                                                    ...
                                                    <div className="flex flex-col gap-2 mt-3">
                                                        {msg.actionButtons.map((btn, idx) => (
                                                            <button
                                                                ...
                                                                className="w-full text-center bg-indigo-50 dark:bg-slate-700 hover:bg-indigo-100 transition-colors text-indigo-600 dark:text-indigo-400 py-2 rounded-xl font-bold text-sm"
                                                            >
                                                                {btn.label}
                                                            </button>
                                                        ))}
                                        ...
                                        try {
                                            ...
                                            if (result) {
                                                ...
                                                if (parsed && (parsed.contents || parsed.saza)) {
                                                    ...
                                                    if (user?.uid) { // Changed userData to user for consistency with the rest of the file
