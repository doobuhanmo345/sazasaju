...
export const getLoadingText = (progress, lang, type = 'main') => {
  ...
  if (type === 'wealth') {
    if (lang === 'ko') {
      ...
      if (progress < 20) return 'Gathering your financial energies scattered within the cosmic flow...';
      if (progress < 40) return 'Analyzing your innate wealth potential and the balance of Five Elements...';
      if (progress < 60) return 'Exploring upcoming financial opportunities and the flow of major luck...';
      if (progress < 80) return 'Calculating the synergy between wealth-attracting habits and protection...';
