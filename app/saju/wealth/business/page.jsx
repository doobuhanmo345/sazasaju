                        ...
                        <div className="flex flex-col items-center gap-4 py-8">
                            <button
                                ...
                                className={`w-full sm:w-auto px-16 py-6 font-bold text-xl rounded-2xl shadow-2xl transform transition-all flex items-center justify-center gap-3 ${isDisabled || isDisabled2
                                    ...
                                    : 'bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white shadow-emerald-400 dark:shadow-emerald-900/50 hover:-translate-y-1 hover:shadow-emerald-500'
                                    }`}
                            >
