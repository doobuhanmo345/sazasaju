...
// Server Component for /saju/share/saza/[id]
export default async function SazaShareIdPage({ params, searchParams }) {
    ...
    return <SazaShareTemplate shareData={data} language={language} />;
}
