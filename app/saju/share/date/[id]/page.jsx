...
// Server Component for /saju/share/date/[id]
export default async function DateShareIdPage({ params, searchParams }) {
    ...
    return <DateShareTemplate shareData={data} language={language} />;
}
