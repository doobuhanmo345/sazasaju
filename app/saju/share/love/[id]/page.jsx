...
// Server Component for /saju/share/love/[id]
export default async function LoveShareIdPage({ params, searchParams }) {
    ...
    return <LoveShareTemplate shareData={data} language={language} />;
}
