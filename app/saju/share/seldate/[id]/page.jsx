...
// Server Component for /saju/share/seldate/[id]
export default async function SelDateShareIdPage({ params, searchParams }) {
    ...
    return <SelDateShareTemplate shareData={data} language={language} />;
}
