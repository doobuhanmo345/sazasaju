...
import WealthShareTemplate from '../WealthShareTemplate';
import { headers } from 'next/headers';

// Server Component for /saju/share/wealth/[id]
export default async function WealthShareIdPage({ params, searchParams }) {
    ...
    return <WealthShareTemplate shareData={data} language={language} />;
}
