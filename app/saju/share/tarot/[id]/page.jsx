...
// Server Component for /saju/share/tarot/[id]
export default async function TarotShareIdPage({ params, searchParams }) {
    ...
    return <TarotShareTemplate shareData={data} language={language} />;
}
