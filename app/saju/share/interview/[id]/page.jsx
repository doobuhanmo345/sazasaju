...
// Server Component for /saju/share/interview/[id]
export default async function InterviewShareIdPage({ params, searchParams }) {
    ...
    return <InterviewShareTemplate shareData={data} language={language} />;
}
