...
// Server Component for /saju/share/selbirth/[id]
export default async function SelBirthShareIdPage({ params, searchParams }) {
    ...
    return <SelBirthShareTemplate shareData={data} language={language} />;
}
