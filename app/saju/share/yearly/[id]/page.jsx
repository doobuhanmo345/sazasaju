...
// Server Component for /saju/share/yearly/[id]
export default async function YearlyShareIdPage({ params, searchParams }) {
    ...
    return <YearlyShareTemplate shareData={data} language={language} />;
}
