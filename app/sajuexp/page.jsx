...
export default function SajuExpPage() {
  ...
  return (
    <main className="min-h-screen pt-20 pb-12 bg-stone-50 dark:bg-slate-900 text-stone-700 dark:text-stone-300 transition-colors pb-24 font-sans selection:bg-indigo-100 dark:selection:bg-indigo-900">
