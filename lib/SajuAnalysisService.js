...
class AnalysisPresets {
  ...
  static match(params) {
    return {
      ...
      promptPaths: ['prompt/match_basic', 'prompt/match_strict', 'prompt/match_specific', 'prompt/default_instruction'],
  ...
  static wealth(params) {
    return {
      ...
      params,
      cacheKey: 'ZWealth',
      promptPaths: ['prompt/wealth_basic', 'prompt/wealth_strict', 'prompt/default_instruction'],
