...
export const createPromptForGemini = async (sajuData, language = 'ko') => {
  ...
  try {
    ...
    // [NEW] Hardcoded Format for Safety (Use DB if valid, else fallback to new schema)
    // Actually, force new schema since ReportTemplateBasic.jsx changed.
    const newTargetFormat = `
{
  "corePersonality": {
    ...
    "metaphor": "String",
    "essence": "String",
    "strengths": ["String (List of 3)"],
    "risks": ["String (List of 3)"],
    "keywords": ["String (List of 3 hashtags)"]
  },
  "personalityOverview": {
    "desc": "String (Comprehensive overview)"
  },
  "lensInterpretations": {
    "wealth": { "summary": "String", "desc": "String" },
    "job": { "summary": "String", "desc": "String" },
    "love": { "summary": "String", "desc": "String" },
    "health": { "summary": "String", "desc": "String" },
    "conflict": { "summary": "String", "desc": "String" },
    "relationship": { "summary": "String", "desc": "String" }
  },
  "timingAndFlow": {
    "principle": "String",
    "daewoon": [
...
`;
    const dbTargetFormat = newTargetFormat; // Override DB format
    ...
    const replacements = {
      ...
      '{{daewoonStories}}': daewoonList
        ...
        .join('\n'),
      '{{targetFormat}}': dbTargetFormat, // 👈 DB 데이터 overwritten
